...
public class CreateTeacherSection extends JPanel {
    ...
    public CreateTeacherSection() {
        ...
        setPreferredSize (new Dimension (549, 426));
        setLayout (null);
    ...
    public static void main (String[] args) {
        JFrame frame = new JFrame ("CreateTeacherSection");
        frame.setDefaultCloseOperation (JFrame.EXIT_ON_CLOSE);
        frame.getContentPane().add (new CreateTeacherSection());
        frame.pack();
